...
IFILE1=0
for FILE1 in jsons/currentdralltriggers_with_IP/L1_*_HLT_*_Excl_Golden.json; do
    IFILE2=0
    for FILE2 in jsons/currentdralltriggers_with_IP/L1_*_HLT_*_Excl_Golden.json; do
